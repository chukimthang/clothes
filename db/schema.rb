...
ActiveRecord::Schema.define(version: 20171016160354) do
  ...
  create_table "receivers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.string "fullname"
    t.string "phone"
    t.string "address"
    t.datetime "created_at", null: false
